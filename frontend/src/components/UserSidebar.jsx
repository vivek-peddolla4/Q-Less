import { Home, Stethoscope, FileText, User, ChevronRight } from 'lucide-react';

export default function UserSidebar({ activeTab, setActiveTab }) {
  const tabs = [
    { id: 'home', label: 'Home', icon: <Home className="w-5 h-5" /> },
    { id: 'history', label: 'Medical History', icon: <Stethoscope className="w-5 h-5" /> },
    { id: 'reports', label: 'Medical Reports', icon: <FileText className="w-5 h-5" /> },
